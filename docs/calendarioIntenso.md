...
- Perfil: layout full-screen en desktop, proporciones mobile 25-75.
- Personajes: barras HP y stats en creador y perfil.
- Seeders completados (AdminUser, Race, Mount, ShopItems).
- Inventario: fix sintaxis Blade.
- CSS: perfil responsive.
